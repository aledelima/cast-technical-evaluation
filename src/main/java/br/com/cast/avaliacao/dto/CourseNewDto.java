...
import br.com.cast.avaliacao.service.validation.CourseInsert;
...
public class CourseNewDto implements Serializable {
	...
	public CourseNewDto(Integer id, String description, LocalDate begin, LocalDate end, Integer studentsQtd, Integer categoryId) {
		this.id = id;
